...
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,207 | 🐛 473 | 🌐 Go | 📅 2026-09-07 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,215 | 🐛 165 | 🌐 Go | 📅 2026-09-06 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,959 | 🐛 1,274 | 🌐 Go | 📅 2026-09-07 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,989 | 🐛 139 | 🌐 Python | 📅 2026-09-07 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,863 | 🐛 210 | 🌐 Go | 📅 2026-09-07 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,577 | 🐛 163 | 🌐 Python | 📅 2026-09-07 is a framework to build portable, production-ready MLOps pipelines.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,695 | 🐛 114 | 🌐 Python | 📅 2026-09-07 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-07 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
