...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,882 | 🐛 1 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,227 | 🐛 372 | 🌐 Go | 📅 2026-09-25 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,229 | 🐛 226 | 🌐 Go | 📅 2026-09-24 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Arena](https://github.com/kubeflow/arena) ⭐ 819 | 🐛 49 | 🌐 Go | 📅 2026-09-25 is a CLI for Kubeflow.

Other open source projects that use or integrate with Kubeflow:

* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 17,004 | 🐛 1,295 | 🌐 Go | 📅 2026-09-25 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 11,008 | 🐛 143 | 🌐 Python | 📅 2026-09-25 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,999 | 🐛 216 | 🌐 Go | 📅 2026-09-25 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,591 | 🐛 168 | 🌐 Python | 📅 2026-09-25 is a framework to build portable, production-ready MLOps pipelines.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,735 | 🐛 125 | 🌐 MDX | 📅 2026-09-24 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,698 | 🐛 117 | 🌐 Python | 📅 2026-09-24 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 705 | 🐛 55 | 🌐 Python | 📅 2026-09-25 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 139 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-25 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
...
* [Kubeflow Steering Committee (KSC)](https://github.com/kubeflow/community/blob/master/KUBEFLOW-STEERING-COMMITTEE.md) ⭐ 199 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-09-16
* [Working Groups](https://github.com/kubeflow/community/blob/master/wg-list.md) ⭐ 199 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-09-16
* [Community Governance](https://github.com/kubeflow/community/blob/master/wgs/wg-governance.md) ⭐ 199 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-09-16
* Community User Surveys ([2024](https://github.com/kubeflow/community/issues/708#issuecomment-2058759541) ⭐ 199 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-09-16, [2023](https://blog.kubeflow.org/kubeflow-user-survey-2023/), [2022](https://blog.kubeflow.org/kubeflow-user-survey-2022/), [2019 Fall](https://medium.com/kubeflow/kubeflow-community-user-survey-fall-2019-a84776c71743), [2019 Spring](https://medium.com/kubeflow/kubeflow-community-user-survey-spring-2019-44f86c794e67))
