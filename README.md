...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,860 | 🐛 0 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,210 | 🐛 485 | 🌐 Go | 📅 2026-09-10 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,216 | 🐛 187 | 🌐 Go | 📅 2026-09-11 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,968 | 🐛 1,288 | 🌐 Go | 📅 2026-09-11 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,993 | 🐛 138 | 🌐 Python | 📅 2026-09-11 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,878 | 🐛 223 | 🌐 Go | 📅 2026-09-11 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,580 | 🐛 166 | 🌐 Python | 📅 2026-09-11 is a framework to build portable, production-ready MLOps pipelines.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,729 | 🐛 125 | 🌐 MDX | 📅 2026-09-09 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-11 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
