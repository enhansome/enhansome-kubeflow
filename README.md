...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,873 | 🐛 1 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,222 | 🐛 506 | 🌐 Go | 📅 2026-09-20 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
...
* [Katib](https://github.com/kubeflow/katib) ⭐ 1,703 | 🐛 118 | 🌐 Python | 📅 2026-09-20 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,994 | 🐛 1,289 | 🌐 Go | 📅 2026-09-20 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
...
* [KServe](https://github.com/kserve/kserve) ⭐ 5,976 | 🐛 206 | 🌐 Go | 📅 2026-09-19 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,587 | 🐛 165 | 🌐 Python | 📅 2026-09-20 is a framework to build portable, production-ready MLOps pipelines.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,732 | 🐛 125 | 🌐 MDX | 📅 2026-09-19 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,697 | 🐛 118 | 🌐 Python | 📅 2026-09-20 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 705 | 🐛 54 | 🌐 Python | 📅 2026-09-18 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
