...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,827 | 🐛 0 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,192 | 🐛 468 | 🌐 Python | 📅 2026-08-24 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,196 | 🐛 166 | 🌐 Go | 📅 2026-08-22 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,931 | 🐛 1,268 | 🌐 Go | 📅 2026-08-24 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,967 | 🐛 139 | 🌐 Python | 📅 2026-08-24 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,825 | 🐛 205 | 🌐 Go | 📅 2026-08-24 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,561 | 🐛 161 | 🌐 Python | 📅 2026-08-24 is a framework to build portable, production-ready MLOps pipelines.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,693 | 🐛 122 | 🌐 Python | 📅 2026-08-24 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-24 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
