...
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,227 | 🐛 365 | 🌐 Go | 📅 2026-09-24 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,227 | 🐛 220 | 🌐 Go | 📅 2026-09-24 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 17,003 | 🐛 1,298 | 🌐 Go | 📅 2026-09-24 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 11,007 | 🐛 138 | 🌐 Python | 📅 2026-09-24 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,998 | 🐛 217 | 🌐 Go | 📅 2026-09-24 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,591 | 🐛 165 | 🌐 Python | 📅 2026-09-24 is a framework to build portable, production-ready MLOps pipelines.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 705 | 🐛 54 | 🌐 Python | 📅 2026-09-23 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 139 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
