...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,868 | 🐛 1 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,212 | 🐛 502 | 🌐 Go | 📅 2026-09-14 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,219 | 🐛 190 | 🌐 Go | 📅 2026-09-12 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
* [Katib](https://github.com/kubeflow/katib) ⭐ 1,699 | 🐛 120 | 🌐 Python | 📅 2026-09-14 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,977 | 🐛 1,282 | 🌐 Go | 📅 2026-09-14 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,996 | 🐛 137 | 🌐 Python | 📅 2026-09-11 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,905 | 🐛 212 | 🌐 Go | 📅 2026-09-14 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,581 | 🐛 170 | 🌐 Python | 📅 2026-09-14 is a framework to build portable, production-ready MLOps pipelines.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,730 | 🐛 125 | 🌐 MDX | 📅 2026-09-14 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,694 | 🐛 122 | 🌐 Python | 📅 2026-09-14 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 704 | 🐛 66 | 🌐 Python | 📅 2026-09-14 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 135 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-14 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
...
* [Kubeflow Steering Committee (KSC)](https://github.com/kubeflow/community/blob/master/KUBEFLOW-STEERING-COMMITTEE.md) ⭐ 199 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-11
* [Working Groups](https://github.com/kubeflow/community/blob/master/wg-list.md) ⭐ 199 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-11
* [Community Governance](https://github.com/kubeflow/community/blob/master/wgs/wg-governance.md) ⭐ 199 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-11
* Community User Surveys ([2024](https://github.com/kubeflow/community/issues/708#issuecomment-2058759541) ⭐ 199 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2026-09-11, [2023](https://blog.kubeflow.org/kubeflow-user-survey-2023/), [2022](https://blog.kubeflow.org/kubeflow-user-survey-2022/), [2019 Fall](https://medium.com/kubeflow/kubeflow-community-user-survey-fall-2019-a84776c71743), [2019 Spring](https://medium.com/kubeflow/kubeflow-community-user-survey-spring-2019-44f86c794e67))
