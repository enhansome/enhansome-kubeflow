...
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,193 | 🐛 460 | 🌐 Python | 📅 2026-08-26 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,198 | 🐛 173 | 🌐 Go | 📅 2026-08-26 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
* [Katib](https://github.com/kubeflow/katib) ⭐ 1,697 | 🐛 110 | 🌐 Python | 📅 2026-08-06 is a Kubernetes-native project for automated machine learning (AutoML).
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,939 | 🐛 1,268 | 🌐 Go | 📅 2026-08-26 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,971 | 🐛 140 | 🌐 Python | 📅 2026-08-26 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,834 | 🐛 203 | 🌐 Go | 📅 2026-08-26 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,564 | 🐛 160 | 🌐 Python | 📅 2026-08-26 is a framework to build portable, production-ready MLOps pipelines.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,723 | 🐛 126 | 🌐 MDX | 📅 2026-08-26 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,692 | 🐛 120 | 🌐 Python | 📅 2026-08-26 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 704 | 🐛 58 | 🌐 Python | 📅 2026-08-24 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 128 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-26 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
...
* [Kubeflow Steering Committee (KSC)](https://github.com/kubeflow/community/blob/master/KUBEFLOW-STEERING-COMMITTEE.md) ⭐ 197 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-17
* [Working Groups](https://github.com/kubeflow/community/blob/master/wg-list.md) ⭐ 197 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-17
* [Community Governance](https://github.com/kubeflow/community/blob/master/wgs/wg-governance.md) ⭐ 197 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-17
* Community User Surveys ([2024](https://github.com/kubeflow/community/issues/708#issuecomment-2058759541) ⭐ 197 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-17, [2023](https://blog.kubeflow.org/kubeflow-user-survey-2023/), [2022](https://blog.kubeflow.org/kubeflow-user-survey-2022/), [2019 Fall](https://medium.com/kubeflow/kubeflow-community-user-survey-fall-2019-a84776c71743), [2019 Spring](https://medium.com/kubeflow/kubeflow-community-user-survey-spring-2019-44f86c794e67))
