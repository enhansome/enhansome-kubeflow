...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,828 | 🐛 0 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,192 | 🐛 465 | 🌐 Python | 📅 2026-08-24 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,196 | 🐛 167 | 🌐 Go | 📅 2026-08-22 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,932 | 🐛 1,269 | 🌐 Go | 📅 2026-08-24 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,968 | 🐛 140 | 🌐 Python | 📅 2026-08-24 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,826 | 🐛 207 | 🌐 Go | 📅 2026-08-24 is a standardized serverless ML inference platform on Kubernetes.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 703 | 🐛 58 | 🌐 Python | 📅 2026-08-19 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-24 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
