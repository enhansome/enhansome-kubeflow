...
* [Kubeflow Main Repository](https://github.com/kubeflow/kubeflow) ⭐ 15,861 | 🐛 0 | 📅 2026-08-21 which provides the front-end to access major components of Kubeflow.
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,211 | 🐛 487 | 🌐 Go | 📅 2026-09-10 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,217 | 🐛 187 | 🌐 Go | 📅 2026-09-12 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
* [Katib](https://github.com/kubeflow/katib) ⭐ 1,699 | 🐛 117 | 🌐 Python | 📅 2026-09-10 is a Kubernetes-native project for automated machine learning (AutoML).
* [Arena](https://github.com/kubeflow/arena) ⭐ 820 | 🐛 51 | 🌐 Go | 📅 2026-09-10 is a CLI for Kubeflow.

Other open source projects that use or integrate with Kubeflow:

* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,971 | 🐛 1,287 | 🌐 Go | 📅 2026-09-11 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,994 | 🐛 137 | 🌐 Python | 📅 2026-09-11 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,883 | 🐛 222 | 🌐 Go | 📅 2026-09-12 is a standardized serverless ML inference platform on Kubernetes.
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,729 | 🐛 125 | 🌐 MDX | 📅 2026-09-12 is a platform for building, training, and monitoring large scale deep learning applications.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 134 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-12 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
