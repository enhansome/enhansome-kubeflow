...
* [Pipelines](https://github.com/kubeflow/pipelines) ⭐ 4,182 | 🐛 491 | 🌐 Python | 📅 2026-08-13 is dedicated to making deployments of machine learning workflows on Kubernetes simple, portable, and scalable with Kubeflow.
* [Training Operator](https://github.com/kubeflow/training-operator) ⭐ 2,182 | 🐛 164 | 🌐 Go | 📅 2026-08-11 provides Kubernetes custom resources that makes it easy to run distributed or non-distributed TensorFlow/PyTorch/Apache MXNet/XGBoost/MPI jobs on Kubernetes.
...
* [Argo Workflows](https://github.com/argoproj/argo-workflows) ⭐ 16,897 | 🐛 1,260 | 🌐 Go | 📅 2026-08-13 is a container-native workflow engine for orchestrating parallel jobs on Kubernetes.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,954 | 🐛 153 | 🌐 Python | 📅 2026-08-13 is an open-source Python framework for creating reproducible, maintainable and modular data science code.
* [KServe](https://github.com/kserve/kserve) ⭐ 5,790 | 🐛 193 | 🌐 Go | 📅 2026-08-13 is a standardized serverless ML inference platform on Kubernetes.
* [ZenML](https://github.com/zenml-io/zenml) ⭐ 5,556 | 🐛 148 | 🌐 Python | 📅 2026-08-13 is a framework to build portable, production-ready MLOps pipelines.
...
* [MLRun](https://github.com/mlrun/mlrun) ⭐ 1,690 | 🐛 111 | 🌐 Python | 📅 2026-08-13 is an open MLOps platform for quickly building and managing continuous ML applications across their lifecycle.
...
* [Kale](https://github.com/kubeflow-kale/kale) ⭐ 700 | 🐛 52 | 🌐 Python | 📅 2026-08-13 is aims at simplifying the data science experience of deploying Kubeflow Pipelines workflows.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 127 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-13 is a multi-cluster Kubernetes dashboard with AI/ML workload observability, GPU utilization tracking, and CNCF project integrations including Kubeflow pipeline monitoring.
  <a name="books" />
